...
public final class OpenSourceApplicationCatalog {
    ...
    public static List<Application> applications() {
        return List.of(
            ...
            app("okular", "Okular", "documents", "PDF and document viewing", true, true, "GPL-2.0-or-later", "native-packages", "KDE/Windows"),
            ...
            app("gnome-files", "GNOME Files", "desktop", "file management", true, false, "GPL-3.0-or-later", "native-packages"),
            app("gnome-system-monitor", "GNOME System Monitor", "desktop", "resource and process monitoring", true, false, "GPL-2.0-or-later", "native-packages"),
